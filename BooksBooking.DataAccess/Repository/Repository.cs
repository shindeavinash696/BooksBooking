...
namespace BooksBooking.DataAccess.Repository
{
    public class Repository<T> : IRepository<T> where T :class
    {
        ...
        public T Get(System.Linq.Expressions.Expression<Func<T, bool>> filter, string? includeProperty = null, bool tracked = false)
        {
            IQueryable<T> query;
            if (tracked)
            {
        ...
        public IEnumerable<T> GetAll(System.Linq.Expressions.Expression<Func<T, bool>>? filter,string? includeProperty = null)
        {
